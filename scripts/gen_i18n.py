...
- I18nStrings.h:  String data blob and offset table declarations
- I18nStrings.cpp: String data blobs, offset tables, and metadata arrays
...
def load_translations(
    ...
    Read every YAML file in *translations_dir* and return:
        ...
        inherited_sets   [set_of_keys_inherited_per_language]
