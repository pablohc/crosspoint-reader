...
enum class StrId : uint16_t {
  ...
  STR_CAT_CONTROLS,
  STR_CAT_SYSTEM,
  STR_SLEEP_SCREEN_MODE,
  STR_SLEEP_SCREEN_FILTER,
  STR_SLEEP_LOGO,
  STR_SLEEP_CUSTOM,
  STR_SLEEP_COVER_FIT,
  STR_SLEEP_COVER_CROP,
  STR_SLEEP_READING_PROGRESS,
  STR_SLEEP_NONE,
  STR_SLEEP_FILTER_NONE,
  STR_SLEEP_FILTER_CONTRAST,
  STR_SLEEP_FILTER_NEGATIVE,
  STR_HIDE_BATTERY,
  STR_EXTRA_SPACING,
  STR_TEXT_AA,
  STR_IMAGES,
  ...
  STR_HOME_COVER,
  STR_HOME_COVER_ENABLED,
  STR_HOME_COVER_TIMEOUT,
  STR_HOME_COVER_DISABLED,
  STR_HOME_COVER_ACTION_DISABLE,
  STR_HOME_COVER_ACTION_ENABLE,
  STR_HOME_COVER_ACTION_GENERATE,
